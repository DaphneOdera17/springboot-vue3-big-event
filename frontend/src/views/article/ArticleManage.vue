...
const articleList = async ()=>{
  ...
  // 将分类 id 转换成分类名称
  const categoryMap = new Map(categorys.value.map(category => [category.id, category.categoryName]));
  ...
  <el-card class="page-container">
    <template #header>
      <div class="header">
        <span>文章管理</span>
        <div class="extra">
          <el-button type="primary" @click="title='添加文章'; clearData(); visibleDrawer=true;">添加文章</el-button>
        </div>
      </div>
    </template>
    <!-- 搜索表单 -->
